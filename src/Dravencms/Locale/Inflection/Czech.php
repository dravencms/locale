    ...
    private function Xedeten($txt2)
    {
        ...
        for ($XdeteneI = 0; $XdeteneI < mb_strlen($txt2, 'UTF-8') - 1; $XdeteneI++) {
            if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "d" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "ě" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i")) {
                ...
                if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "t" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "ě" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i")) {
                    $XdeteneRV .= "ť";
                    if (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "ě") {
                        $XdeteneRV .= "e";
                        $XdeteneI++;
                    ...
                    if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "n" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "ě" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i")) {
                        $XdeteneRV .= "ň";
                        if (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "ě") {
                            $XdeteneRV .= "e";
                            $XdeteneI++;
...
// Sklonovani podle standardniho seznamu pripon
    ...
    private function Sklon($nPad, $vzndx, $txt, $zivotne = false)
    {
        ...
        if ($ndx1 != mb_strlen($rv, 'UTF-8') && $ndx2 != mb_strlen($rv, 'UTF-8')) {
            if ($zivotne) // "text-xxx/yyy" -> "textyyy"
            {
                $rv = $this->LeftStr($ndx1, $rv) . $this->RightStr($ndx2 + 1, $rv);
            } else // "text-xxx/yyy" -> "text-xxx"
            {
...
// Pokud je index>=0, je $slovo výjimka ze seznamu "$vx"(v10,...), definovaného výše.
    ...
    private function Xdetene($txt2)
    {
        $XdeteneRV = "";
        for ($XdeteneI = 0; $XdeteneI < mb_strlen($txt2, 'UTF-8') - 1; $XdeteneI++) {
            if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "ď" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "e" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i" || mb_substr($txt2,
                        $XdeteneI + 1, 1, 'UTF-8') == "í")
            ) {
                $XdeteneRV .= "d";
                ...
                if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "ť" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "e" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i" || mb_substr($txt2,
                            $XdeteneI + 1, 1, 'UTF-8') == "í")
                ) {
                    $XdeteneRV .= "t";
                    if (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "e") {
                    ...
                    if (mb_substr($txt2, $XdeteneI, 1, 'UTF-8') == "ň" && (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "e" || mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "i" || mb_substr($txt2,
                                $XdeteneI + 1, 1, 'UTF-8') == "í")
                    ) {
                        $XdeteneRV .= "n";
                        if (mb_substr($txt2, $XdeteneI + 1, 1, 'UTF-8') == "e") {
    ...
    private function CmpFrm($txt)
    {
        ...
        for ($CmpFrmI = 0; $CmpFrmI < mb_strlen($txt, 'UTF-8'); $CmpFrmI++) {
            if (mb_substr($txt, $CmpFrmI, 1, 'UTF-8') == "0") {
                ...
                if (mb_substr($txt, $CmpFrmI, 1, 'UTF-8') == "1") {
                    $CmpFrmRV .= $this->aCmpReg[1];
                } else {
                    if (mb_substr($txt, $CmpFrmI, 1, 'UTF-8') == "2") {
